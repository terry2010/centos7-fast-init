...
docker run --name my-mysql -d --network=host -v /data1/data/mysql:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=155313724 mysql:5.7 --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci
